...
class Constants:
    ...
    #the dataframe has been clean and can be used for plotting
        ...
        while(done == False):
                try:
                    ...
                    if self.last_entry_read == 0:
                        ...
                        result = requests.post(f'{self.server}/{path_name}/create', data=json.dumps(data), headers=self.headers).json()
                        print("Result",result)
                        ...
                        result = requests.put(f'{self.server}/{path_name}/update',data=json.dumps(data), headers=self.headers)
                        print('Result',result)
                    ...
                    result = requests.put(f'{self.server}/{path_name}/update', data=json.dumps(data),headers=self.headers).json()
                    print('result',result)